...
-- blir i denne branchen erstattet av den nye varsel-tabellen og skal kun brukes til arkiv-formål.
-- Siden vi uansett har "mistet" mange varsler i denne databasen, har Team Min side laget et script for å inaktivere alle varslene våre før vi merger denne branchen.
-- Vi har samtidig sett at vi har en del brukere som ikke har sendt meldekort, så da får vi muligheten til å re-varsle alle meldekort som mangler innsendinger.
...
-- denne indeksen dekker også oppslag på kun sak_id
...
CREATE INDEX idx_varsel_skal_aktiveres_tidspunkt
...
CREATE INDEX idx_varsel_skal_inaktiveres_pending
