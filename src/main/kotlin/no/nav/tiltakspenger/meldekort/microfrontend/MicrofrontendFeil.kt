...
/**
 * Feil som kan oppstå i microfrontend-pakken. De lavere lagene (repo og klient) returnerer disse som
 * venstre-side i en [arrow.core.Either] i stedet for å kaste, slik at ytterste lag (en jobb eller en route)
 * kan ta stilling til hva som bør gjøres.
 *
