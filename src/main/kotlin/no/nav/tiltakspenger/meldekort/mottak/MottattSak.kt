 ...
 *
 * I motsetning til lesemodellen [Sak] inneholder denne kun feltene saksbehandling-api faktisk
 * sender oss. Leseside-felter som [Sak.arenaMeldekortStatus] (som settes/oppdateres av egne jobber
 * i dette repoet) finnes derfor ikke her. Servicen avgjør om den mottatte saken skal lagres som ny
 * eller oppdatere en eksisterende.
 */
