 ...
 * faktisk trenger, ikke hele [no.nav.tiltakspenger.meldekort.sak.Sak]-aggregatet.
 *
 ...
 * [no.nav.tiltakspenger.meldekort.varsler.VarselMeldekortRepo.hentFørsteKjedeSomManglerInnsending].
 *
 * [sistFlaggetTidspunkt] brukes som optimistisk lås: når jobben fullfører og kaller
 * [no.nav.tiltakspenger.meldekort.varsler.SakVarselRepo.markerVarselVurdert], oppdateres
 ...
 * [no.nav.tiltakspenger.meldekort.varsler.SakVarselRepo.flaggForVarselvurdering] underveis,
