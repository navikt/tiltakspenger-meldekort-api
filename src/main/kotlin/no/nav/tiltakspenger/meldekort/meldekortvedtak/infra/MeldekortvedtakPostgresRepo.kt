...
object MeldekortvedtakPostgresRepo {
    ...
    fun hentForSakId(sakId: SakId, session: Session): List<Meldekortvedtak> {
        ...
        // Radene materialiseres fullt ut inne i .map (til Rad) før ResultSet lukkes - hentForSakId kalles nestet inne i SakPostgresRepo.fromRow sin egen åpne ResultSet, så vi kan ikke holde på Row-referanser.
