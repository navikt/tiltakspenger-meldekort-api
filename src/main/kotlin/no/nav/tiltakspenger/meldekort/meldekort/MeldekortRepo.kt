...
interface MeldekortRepo {
    ...
    /**
     * Skriver brukerens innsending ([BrukersMeldekort.mottatt], [BrukersMeldekort.dager] og
     * [BrukersMeldekort.locale]) til et eksisterende meldekort, men kun dersom det fortsatt er åpent for
     * innsending (ikke allerede mottatt og ikke deaktivert). Dette håndhever atomisk i databasen at kun et
     * meldekort i [no.nav.tiltakspenger.meldekort.meldekort.MeldekortStatus.KAN_UTFYLLES] kan sendes inn, og
     * lukker race-vinduet mellom lesing og skriving ved samtidige innsendinger.
     *
