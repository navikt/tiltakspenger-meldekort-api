...
class MottaSakerRouteTest {
    ...
    fun `Skal lagre meldeperioden og opprette meldekort`() {
        ...
        val dto = ObjectMother.sakDTO()
        val id = SakId.fromString(dto.sakId)

        testMedMeldekortRoutes(tac) {
            mottaSakRequest(dto).apply {
                status shouldBe HttpStatusCode.OK

                tac.sakRepo.hent(id) shouldBe dto.tilSak().getOrFail()
            }
        }
    }
...
//            }
//
//            mottaSakRequest(dtoMedDiff).apply {
