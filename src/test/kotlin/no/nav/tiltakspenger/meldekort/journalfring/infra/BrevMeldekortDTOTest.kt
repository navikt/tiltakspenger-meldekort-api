...
import no.nav.tiltakspenger.meldekort.journalføring.infra.BrevMeldekortDTO
import no.nav.tiltakspenger.meldekort.journalføring.infra.tilBrevMeldekortStatusDTO
    ...
    inner class ToBrevMeldekortDTO {
        ...
        fun `statuser for dagene blir riktig formatert`() {
            ...
            val statusMap = linkedMapOf(
                ...
                mandagDenneUken.plusDays(4) to MeldekortDagStatus.FRAVÆR_STERKE_VELFERDSGRUNNER_ELLER_JOBBINTERVJU,
