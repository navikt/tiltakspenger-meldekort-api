...
/**
 * Round-trip-test for den gamle JSONB-serialiseringen av hele behandlingslista
 * (`meldekortvedtak.meldeperiodebehandlinger`). Beholdes så lenge appen dual-skriver til den gamle
 * kolonnen (expand-fase). Fjernes sammen med [tilMeldeperiodebehandlingerDbJson] i contract-steget.
 */
class MeldeperiodebehandlingDbJsonTest {
